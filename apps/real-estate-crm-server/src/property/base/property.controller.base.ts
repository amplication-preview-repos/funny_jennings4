...
import { AppointmentCreateInput } from "../../appointment/base/AppointmentCreateInput";
...
export class PropertyControllerBase {
  ...
  @common.Post("/properties/:propertyId/assign-agent")
  ...
  async AssignAgent(
    ...
    return this.service.AssignAgent(body);
  }

  @common.Get("/properties/search")
  @swagger.ApiOkResponse({
    type: Appointment,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async SearchProperties(
    @common.Body()
    body: AppointmentWhereInput
  ): Promise<Appointment[]> {
    return this.service.SearchProperties(body);
  }
}
